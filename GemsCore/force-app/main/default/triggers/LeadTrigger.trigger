//ActionPlanObjectTriggerTest & LeadTriggerTest
trigger LeadTrigger on Lead (after undelete, before delete, after insert, after update, before update) {
    ...
    {        
    	LeadTriggerHandler.makePullAPICallout();
    }
